...
alias _XImage * function(void *, Visual *, size_t, int, int, char *, size_t, size_t, int, int) _BCD_func__2079;
...
alias _XImage * function(_XImage *, int, int, size_t, size_t) _BCD_func__2083;
...
extern (C) int XWarpPointer(void *, size_t, size_t, int, int, size_t, size_t, int, int);
...
extern (C) int XUngrabKey(void *, int, size_t, size_t);
extern (C) int XUngrabButton(void *, size_t, size_t, size_t);
...
extern (C) int XSetWindowBorderWidth(void *, size_t, size_t);
...
extern (C) int XResizeWindow(void *, size_t, size_t, size_t);
extern (C) int XResetScreenSaver(void *);
extern (C) int XReparentWindow(void *, size_t, size_t, int, int);
extern (C) int XRemoveHosts(void *, XHostAddress *, int);
extern (C) int XRemoveHost(void *, XHostAddress *);
extern (C) int XRemoveFromSaveSet(void *, size_t);
...
extern (C) int XRaiseWindow(void *, size_t);
...
extern (C) int XQueryBestSize(void *, int, size_t, size_t, size_t, size_t *, size_t *);
extern (C) int XQueryBestCursor(void *, size_t, size_t, size_t, size_t *, size_t *);
...
extern (C) int XParseGeometry(char *, int *, int *, size_t *, size_t *);
...
extern (C) int XMoveResizeWindow(void *, size_t, int, int, size_t, size_t);
...
extern (C) int XGrabPointer(void *, size_t, int, size_t, int, int, size_t, size_t, size_t);
extern (C) int XGrabKeyboard(void *, size_t, int, int, int, size_t);
extern (C) int XGrabKey(void *, int, size_t, size_t, int, int, int);
extern (C) int XGrabButton(void *, size_t, size_t, size_t, int, size_t, int, int, size_t, size_t);
...
extern (C) int XGetGeometry(void *, size_t, size_t *, int *, int *, size_t *, size_t *, size_t *, size_t *);
...
extern (C) int XGeometry(void *, int, char *, char *, size_t, size_t, size_t, int, int, int *, int *, int *, int *);
...
extern (C) int XCopyPlane(void *, size_t, size_t, void *, int, int, size_t, size_t, int, int, size_t);
extern (C) int XCopyGC(void *, void *, size_t, void *);
extern (C) int XCopyArea(void *, size_t, size_t, void *, int, int, size_t, size_t, int, int);
extern (C) int XConvertSelection(void *, size_t, size_t, size_t, size_t, size_t);
extern (C) int XConnectionNumber(void *);
extern (C) int XConfigureWindow(void *, size_t, size_t, XWindowChanges *);
extern (C) int XCloseDisplay(void *);
extern (C) int XClearWindow(void *, size_t);
extern (C) int XClearArea(void *, size_t, int, int, size_t, size_t, int);
...
extern (C) int XChangeActivePointerGrab(void *, size_t, size_t, size_t);
...
extern (C) int XAllocColorCells(void *, size_t, int, size_t *, size_t, size_t *, size_t);
...
extern (C) int XReconfigureWMWindow(void *, size_t, int, size_t, XWindowChanges *);
...
extern (C) size_t XCreateWindow(void *, size_t, int, int, size_t, size_t, size_t, int, size_t, Visual *, size_t, XSetWindowAttributes *);
...
extern (C) size_t XCreatePixmapFromBitmapData(void *, size_t, char *, size_t, size_t, size_t, size_t, size_t);
extern (C) size_t XCreateBitmapFromData(void *, size_t, char *, size_t, size_t);
extern (C) size_t XCreatePixmap(void *, size_t, size_t, size_t, size_t);
...
extern (C) size_t XCreateFontCursor(void *, size_t);
extern (C) size_t XCreateGlyphCursor(void *, size_t, size_t, size_t, size_t, XColor *, XColor *);
extern (C) size_t XCreatePixmapCursor(void *, size_t, size_t, XColor *, XColor *, size_t, size_t);
...
extern (C) _XImage * XGetSubImage(void *, size_t, int, int, size_t, size_t, size_t, int, _XImage *, int, int);
extern (C) _XImage * XGetImage(void *, size_t, int, int, size_t, size_t, size_t, int);
extern (C) int XInitImage(_XImage *);
extern (C) _XImage * XCreateImage(void *, Visual *, size_t, int, int, char *, size_t, size_t, int, int);
