...
function TreeView(candyPath, hrefMode)
{
    ...
    {
        var root = new TreeNode(text, iconSrc, this.hrefMode, this.candyPath);
        root.owner = this;
...
var idCounter = 0;
function TreeNode(text, iconSrc, hrefMode, candyPath)
{
	this.candyPath		= candyPath;
    this.id             = idCounter++;
    ...
    function genHierarchyImageSrc(hierarchyImg)
    {
        ...
        return candyPath + "img/tree/" + name + ".gif";
    }
    ...
    {
        var child = new TreeNode(text, iconSrc, this.owner.hrefMode, this.candyPath);
