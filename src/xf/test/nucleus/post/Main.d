...
class TestApp : GfxApp {
	...
	override void initialize() {
		...
		version (Sponza) {
			...
			camera = new SimpleCamera(vec3(0.74, 2.43, 2.76), -44, 23.4, inputHub.mainChannel);
		}
		...
		lightOffsets[0] = vec3.unitY * 8;
		lightOffsets[1] = vec3.unitY * 8;
		lightOffsets[2] = vec3.unitY * 6;
		...
		//cstring model = `mesh/dragonWithBase.hsf`;
		cstring model = `mesh/teapotWithBase.hsf`;
	...
	override void render() {
		...
		if (0 == lightScale) lightScale = 30.0f / lights.length;
