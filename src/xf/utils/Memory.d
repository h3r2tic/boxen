...
version (RecordMemoryAllocations) {
	uword[cstring]	allocLengths;
	uword[cstring]	allocCounts;
}
...
body {
	...
	array = (cast(ItemT*)mainHeap.allocRaw(ItemT.sizeof * numItems))[0 .. numItems];
...
body {
	...
	array = (cast(ItemT*)mainHeap.reallocRaw(array.ptr, ItemT.sizeof * numItems))[0 .. numItems];
