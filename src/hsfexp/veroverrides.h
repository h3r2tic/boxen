...
#define MAXVER_INTERNALNAME "hsfexp\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "hsfexp.dle\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Heretical Scene Format exporter\0"//should  be overidden on a per-dll level
